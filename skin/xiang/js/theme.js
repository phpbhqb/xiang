...
function(t, e, n) {
    ...
    s = function() {
        ...
        return r(t, [{
            key: "init",
            value: function() { (0, a.
            default)(".js-product-miniature").each(function(t, e) { (0, a.
    ...
    function(t) {
        ...
        if (!t.jQuery) {
            ...
            n.extend = function() {
                ...
                l++), "object" != typeof s && "function" !== n.type(s) && (s = {}), l === u && (s = this, l--); l < u; l++) if (o = arguments[l]) for (r in o) o.hasOwnProperty(r) && (t = s[r], i = o[r], s !== i && (c && i && (n.isPlainObject(i) || (e = n.isArray(i))) ? (e ? (e = !1, a = t && n.isArray(t) ? t: []) : a = t && n.isPlainObject(t) ? t: {},
            ...
            n.queue = function(t, i, r) {
                if (t) {
                    i = (i || "fx") + "queue";
                    var o = n.data(t, i);
                    return r ? (!o || n.isArray(r) ? o = n.data(t, i,
                    function(t, n) {
                        var i = n || [];
                        return t && (e(Object(t)) ?
                        function(t, e) {
            ...
            o = r.hasOwnProperty,
            a = r.toString,
            s = "Boolean Number String Function Array Date RegExp Object Error".split(" "), l = 0; l < s.length; l++) r["[object " + s[l] + "]"] = s[l].toLowerCase();
        ...
        return function(t, e, n, i) {
                        ...
                        for (var w = Math.min(b / u.duration, 1), x = 0, S = l.length; x < S; x++) {
                            ...
                            if (a(A)) {
                                ...
                                for (var D in C) if (C.hasOwnProperty(D) && "element" !== D) {
                                    var N, P = C[D],
                                    j = _.isString(P.easing) ? E.Easings[P.easing] : P.easing;
                                    if (_.isString(P.pattern)) {
                                        ...
                                        N = P.pattern.replace(/{(\d+)(!)?}/g, L)
                                    } else if (1 === w) N = P.endValue;
                                    else {
                                        var B = P.endValue - P.startValue;
                                        N = P.startValue + B * j(w, u, B)
                                    }
            ...
            function p(t, e) {
                ...
                for (var n = E.State.calls[t][0], r = E.State.calls[t][1], o = E.State.calls[t][2], s = E.State.calls[t][4], l = !1, u = 0, c = n.length; u < c; u++) {
                    ...
                    s && !0 !== o.loop && s(r),
                    d && !0 === o.loop && !e && (h.each(d.tweensContainer,
                    function(t, e) {
                ...
                E.State.calls[t] = !1;
                for (var m = 0,
                g = E.State.calls.length; m < g; m++) if (!1 !== E.State.calls[m]) {
                    l = !0;
                    break
            ...
            var h, m = function() {
                ...
                for (var t = 7; t > 4; t--) {
                    ...
                    if (e.innerHTML = "\x3c!--[if IE " + t + "]><span></span><![endif]--\x3e", e.getElementsByTagName("span").length) return e = null,
                    t
                }
                return i
            } (),
            ...
            E = {
                ...
                pauseAll: function(t) {
                    ...
                    h.each(E.State.delayedElements,
                    function(t, n) {
                        n && s(n, e)
                    })
                },
            ...
            var T = E.CSS = {
                ...
                Hooks: {
                    ...
                    fixColors: function(t) {
                        return t.replace(/(rgba?\(\s*)?(\b[a-z]+\b)/g,
                        function(t, e, n) {
            ...
            var A = function t() {
                ...
                function u(t, r) {
                    function o(o) {
                        ...
                        if ("scroll" === N) {
                            ...
                            var P = function(r, o) {
                                ...
                                g = o[1],
                                v = o[2];
                                if (! (c && c.isSVG || "tween" === f || !1 !== T.Names.prefixCheck(f)[1] || T.Normalizations.registered[f] !== i)) return void E.debug; (l.display !== i && null !== l.display && "none" !== l.display || l.visibility !== i && "hidden" !== l.visibility) && /opacity|filter/.test(r) && !v && 0 !== m && (v = 0),
                                ...
                                if (v !== m && _.isString(v) && _.isString(m)) {
                                    ...
                                    for (v = T.Hooks.fixColors(v), m = T.Hooks.fixColors(m); C < v.length && A < m.length;) {
                                        ...
                                        if (/[\d\.-]/.test(P) && /[\d\.-]/.test(j)) {
                                            ...
                                            if (C += M.length, A += H.length, M === H) L === B ? a += L + M: (a += "{" + I.length + (D ? "!": "") + "}" + M, I.push(parseFloat(L)), O.push(parseFloat(B)));
                                            else {
                                                var W = parseFloat(L),
                                                q = parseFloat(B);
                                                a += (k < 5 ? "calc": "") + "(" + (W ? "{" + I.length + (D ? "!": "") + "}": "0") + M + " + " + (q ? "{" + (I.length + (W ? 1 : 0)) + (D ? "!": "") + "}": "0") + H + ")",
                                                W && (I.push(W), O.push(0)),
                                                q && (I.push(0), O.push(q))
                                            }
                                        } else {
                                    ...
                                    a && (I.length ? (E.debug, v = I, m = O, b = w = "") : a = i)
                                }
                                a || (y = S(r, v), v = y[0], w = y[1], y = S(r, m), m = y[0].replace(/^([+-\/*])=/,
                                function(t, e) {
                                    return x = e,
                                    ""
                            ...
                            for (var j in w) if (w.hasOwnProperty(j)) {
                                var L = T.Names.camelCase(j),
                                B = function(e, n) {
                                    var i, o, a;
                                ...
                                if (b(T.Lists.colors, L)) {
                                    var V = B[0],
                                    M = B[1],
                                    H = B[2];
                                    if (T.RegEx.isHex.test(V)) {
                                        for (var W = ["Red", "Green", "Blue"], q = T.Values.hexToRgb(V), z = H ? T.Values.hexToRgb(H) : i, U = 0; U < W.length; U++) {
                                            var $ = [q[U]];
                                            M && $.push(M),
                                            z !== i && $.push(z[U]),
                                            P(L + W[U], $)
                    ...
                    E.defaults, S),
                    u = {};
                    switch (a(t) === i && E.init(t), parseFloat(l.delay) && !1 !== l.queue && h.queue(t, l.queue,
                    function(e) {
                ...
                var c, m, g, v, y, w, S, C = arguments[0] && (arguments[0].p || h.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || _.isString(arguments[0].properties));
                ...
                if (m && E.Promise && (A.promise = new E.Promise(function(t, e) {
                    A.resolver = t,
                    A.rejecter = e
                })), C ? (w = arguments[0].properties || arguments[0].p, S = arguments[0].options || arguments[0].o) : (w = arguments[v], S = arguments[v + 1]), !(y = o(y))) return void(A.promise && (w && S && !1 === S.promiseRejectEmpty ? A.resolver() : A.rejecter()));
                var I = y.length,
                O = 0;
                ...
                case "pause":
                    ...
                    function(t, e) {
                        ...
                        function(t, r) {
                            var o = S === i ? "": S;
                            return ! 0 !== o && e[2].queue !== o && (S !== i || !1 !== e[2].queue) || (h.each(y,
                            function(t, i) {
                                if (i === r) return e[5] = {
                                    resume: !1
                                },
                ...
                case "resume":
                    ...
                    function(t, e) {
                        ...
                        function(t, r) {
                            var o = S === i ? "": S;
                            return ! 0 !== o && e[2].queue !== o && (S !== i || !1 !== e[2].queue) || (!e[5] || (h.each(y,
                            function(t, i) {
                ...
                case "stop":
                    ...
                    function(t, e) {
                        ...
                        "finishAll" !== w || !0 !== S && !_.isString(S) || (h.each(h.queue(e, _.isString(S) ? S: ""),
                        function(t, e) {
                            _.isFunction(e) && e()
                        }), h.queue(e, _.isString(S) ? S: "", []))
                    });
                    var j = [];
                    return h.each(E.State.calls,
                    function(t, e) {
                        e && h.each(e[1],
                        function(n, r) {
                            var o = S === i ? "": S;
                            ...
                            h.each(y,
                            function(n, i) {
                                if (i === r) if ((!0 === S || _.isString(S)) && (h.each(h.queue(i, _.isString(S) ? S: ""),
                                function(t, e) {
                    ...
                    if (!h.isPlainObject(w) || _.isEmptyObject(w)) {
                        if (_.isString(w) && E.Redirects[w]) {
                            ...
                            function(t, e) {
                                ...
                                c.drag && (c.duration = parseFloat(L) || (/^(callout|transition)/.test(w) ? 1e3: x), c.duration = Math.max(c.duration * (c.backwards ? 1 - t / I: (t + 1) / I), .75 * c.duration, 200)),
                                E.Redirects[w].call(e, e, c || {},
                                t, I, y, A.promise ? A: i)
                            }),
                            r()
                        }
...
default.cart.active_inputs = null;
    var u = 'input[name="product-quantity-spin"]'; (0, a.
default)(document).ready(function() {
        ...
        h = [];
        l.
    default.on("updateCart",
        function() { (0, a.
        default)(".quickview").modal("hide")
        }),
        l.
    default.on("updatedCart",
        function() {
            r()
        }),
        r();
    ...
    default)("body"),
        ...
        m.on("click", ".js-discount .code",
        function(t) {
            t.stopPropagation();
            var e = (0, a.
        default)(t.currentTarget);
            return (0, a.
        default)("[name=discount_name]").val(e.text()),
            !1
        })
    })
},
function(t, e, n) {
    ...
    default)(".checkout-step:not(.js-current-step) .step-title").addClass("not-allowed"),
        (0, a.
    default)(".js-terms a").on("click",
        function(t) {
            t.preventDefault();
            var e = (0, a.
        ...
        (0, a.
    default)(".js-gift-checkbox").on("click",
        function(t) { (0, a.
...
default)(document).ready(function() {
        1 === (0, a.
    default)("body#checkout").length && r(),
        l.
    default.on("updatedDeliveryForm",
        function(t) {
...
default.blockcart.showModal = function(t) {
        ...
        n.length && n.remove(),
        (0, s.
    default)("body").append(t),
        n = e(),
        n.modal("show").on("hidden.bs.modal",
        function(t) {
            o.
...
function(t, e, n) {
    ...
    s = function() {
        ...
        },
        {
            key: "parentFocus",
            value: function() { (0, a.
            default)(".js-child-focus").focus(function() { (0, a.
                default)(this).closest(".js-parent-focus").addClass("focus")
                }),
                (0, a.
            default)(".js-child-focus").focusout(function() { (0, a.
        ...
        },
        {
            ...
            value: function() { (0, a.
            default)('button[data-action="show-password"]').on("click",
                function() {
                    var t = (0, a.
                ...
                default)(this).data("textHide"))):
                    (t.attr("type", "password"), (0, a.
                default)(this).text((0, a.
...
function(t, e, n) {
    ...
    var s = function() {
        ...
        return r(t, [{
            ...
            value: function() {
                var t = (0, a.
            default)(".js-modal-arrows"); (0, a.
            default)(".js-modal-product-images"); (0, a.
            default)("body").on("click", ".js-modal-thumb",
                function(t) { (0, a.
                default)(".js-modal-thumb").hasClass("selected") && (0, a.
                default)(".js-modal-thumb").removeClass("selected"),
                    (0, a.
                default)(t.currentTarget).addClass("selected"),
                    (0, a.
    ...
    d = function(t) {
        ...
        a(e, [{
            ...
            value: function() {
                ...
                default)(e.target).data("depth") && (0, u.
                default)("#" + n + " .js-sub-menu").show().css({
                        top: (0, u.
                ...
                (0, u.
            default)("#menu-icon").on("click",
                function() { (0, u.
                default)("#mobile_top_menu_wrapper").toggle(),
                    i.toggleMobileMenu()
                }),
                (0, u.
            default)(".js-top-menu").mouseleave(function() {
                    t.el.parent().hasClass("mobile") || (0, u.
                default)("#" + n + " .js-sub-menu").hide()
                }),
                this.el.on("click",
                function(e) {
                ...
                function(t) { (0, u.
                default)(".js-sub-menu").removeAttr("style"),
                    i.toggleMobileMenu()
                }),
...
function(t, e, n) {
    "use strict";
    function i() { (0, a.
    default)("#order-return-form table thead input[type=checkbox]").on("click",
        function() {
            var t = (0, a.
        default)(this).prop("checked"); (0, a.
        default)("#order-return-form table tbody input[type=checkbox]").each(function(e, n) { (0, a.
    ...
    function(t) {
        t.fn.scrollbox = function(e) {
            ...
            this.each(function() {
                ...
                s = function() {
                    if (!h) {
                        var r, a, s, l, u, c = t(window).scrollTop();
                        if (r = n.children(e.listItemElement + ":first-child"), l = "auto" !== e.distance ? e.distance: "vertical" === e.direction ? r.outerHeight(!0) : r.outerWidth(!0), e.linear ? s = Math.min(f[0][e.scrollOffset] + e.step, l) : (u = Math.max(3, parseInt(.3 * (l - f[0][e.scrollOffset]), 10)), s = Math.min(f[0][e.scrollOffset] + u, l)), f[0][e.scrollOffset] = s, s >= l) {
                            ...
                            ++m;
                            if (f[0][e.scrollOffset] = 0, clearInterval(d), d = null, t(window).scrollTop(c), t.isFunction(e.afterForward) && e.afterForward.call(f, {
                                switchCount: m,
                ...
                l = function() {
                    if (!h) {
                        ...
                        if (e.linear ? s = Math.max(f[0][e.scrollOffset] - e.step, 0) : (u = Math.max(3, parseInt(.3 * f[0][e.scrollOffset], 10)), s = Math.max(f[0][e.scrollOffset] - u, 0)), s > 0 && s < 1 && (s = 0), f[0][e.scrollOffset] = s, 0 === s) {
...
function(t, e, n) {
    ...
    function r(t) { (0, a.
    default)("#search_filters").replaceWith(t.rendered_facets),
        (0, a.
    default)("#js-active-search-filters").replaceWith(t.rendered_active_filters),
        (0, a.
    default)("#js-product-list-top").replaceWith(t.rendered_products_top),
        (0, a.
    default)("#js-product-list").replaceWith(t.rendered_products),
        (0, a.
    default)("#js-product-list-bottom").replaceWith(t.rendered_products_bottom),
        (new c.
    default).init()
    }
    var o = n(0),
...
default)(document).ready(function() {
    ...
    default.on("clickQuickView",
        function(e) {
            ...
            a.
        default.post(l.
        default.urls.pages.product, n, null, "json").then(function(e) { (0, a.
        ...
        var t = function(t) {
            var e = (0, a.
        default)(".js-arrows"),
            n = t.find(".js-qv-product-images"); (0, a.
        default)(".js-thumb").on("click",
            function(t) { (0, a.
            default)(".js-thumb").hasClass("selected") && (0, a.
            default)(".js-thumb").removeClass("selected"),
                (0, a.
            default)(t.currentTarget).addClass("selected"),
                (0, a.
            ...
            if ("vertical" == style_scroll_quickview) var r = n.parent().height();
            else var r = n.parent().width();
            size_item_quickview * i - r >= size_item_quickview ? ((0, a.
        default)(".quickview .js-qv-mask").addClass("scroll"), (0, a.
        default)(".js-arrows").addClass("scroll"), e.show(), (0, a.
        default)(".quickview .js-qv-mask").unbind("backward"), (0, a.
        default)(".quickview .js-qv-mask").unbind("forward"), (0, a.
        default)(".quickview .js-qv-mask").scrollbox({
                direction:
                style_scroll_quickview,
                distance: size_item_quickview,
                autoPlay: !1,
                step: 1
            }), (0, a.
        default)(".arrow-up").click(function() { (0, a.
            default)(".quickview .js-qv-mask").trigger("backward")
            }), (0, a.
        default)(".arrow-down").click(function() { (0, a.
            default)(".quickview .js-qv-mask").trigger("forward")
            })):
            ((0, a.
        default)(".quickview .js-qv-mask").removeClass("scroll"), e.hide(), (0, a.
        default)(".js-arrows").removeClass("scroll")),
    ...
    default)("body").on("click", "#search_filter_toggler",
        function() { (0, a.
        default)("#search_filters_wrapper").removeClass("hidden-sm-down"),
            (0, a.
        default)("#content-wrapper").addClass("hidden-sm-down"),
            (0, a.
        default)("#footer").addClass("hidden-sm-down")
        }),
        (0, a.
    default)("#search_filter_controls .clear").on("click",
        function() { (0, a.
        default)("#search_filters_wrapper").addClass("hidden-sm-down"),
            (0, a.
        default)("#content-wrapper").removeClass("hidden-sm-down"),
            (0, a.
        default)("#footer").removeClass("hidden-sm-down")
        }),
        (0, a.
    default)("#search_filter_controls .ok").on("click",
        function() { (0, a.
        default)("#search_filters_wrapper").addClass("hidden-sm-down"),
            (0, a.
        default)("#content-wrapper").removeClass("hidden-sm-down"),
        ...
        var e = function(t) {
            if (void 0 !== t.target.getAttribute("data-search-url")) return t.target.getAttribute("data-search-url");
            if (void 0 === (0, a.
        default)(t.target).parent()[0].getAttribute("data-search-url")) throw new Error("Can not parse search URL");
            return (0, a.
        default)(t.target).parent()[0].getAttribute("data-search-url")
        }; (0, a.
    default)("body").on("change", "#search_filters input[data-search-url]",
        function(t) {
            l.
        default.emit("updateFacets", e(t))
        }),
        (0, a.
    default)("body").on("click", ".js-search-filters-clear-all",
        function(t) {
            window.location.href=(t.target).closest("button").getAttribute("data-search-url");
        }),
        (0, a.
    default)("body").on("click", ".js-search-link",
        function(t) {
        }),
        (0, a.
    default)("body").on("change", "#search_filters select",
        function(t) {
            var e = (0, a.
...
default)(document).ready(function() {
        ...
        default)(".js-thumb").on("click",
            function(t) { (0, r.
            default)(".js-modal-product-cover").attr("src", (0, r.
            default)(t.target).data("image-large-src")),
                (0, r.
            default)(".selected").removeClass("selected"),
                (0, r.
            default)(t.target).addClass("selected"),
                (0, r.
            default)(".js-qv-product-cover").prop("src", (0, r.
            default)(t.currentTarget).data("image-large-src"))
            })
        }
        function e(t, e) {
            var n = (0, r.
        default)("#main .js-qv-product-images li").length;
            if ("vertical" == style_scroll_page) {
                var i = (0, r.
            default)("#main .js-qv-mask").height();
                1 == t && (size_item_page = (0, r.
            default)("#main .js-qv-product-images li").height())
            } else {
                var i = (0, r.
            default)("#main .js-qv-mask").width();
                1 == t && (size_item_page = (0, r.
            default)("#main .js-qv-product-images li").width())
            }
            if (size_item_page * n - i >= size_item_page ? ((0, r.
        default)("#main .js-qv-mask").addClass("scroll"), (0, r.
        default)("#main .scroll-box-arrows").addClass("scroll"), (0, r.
        default)("#main .js-qv-mask").unbind("backward"), (0, r.
        default)("#main .js-qv-mask").unbind("forward"), (0, r.
        ...
        default)("#main .scroll-box-arrows .left").click(function() { (0, r.
            default)("#main .js-qv-mask").trigger("backward")
            }), (0, r.
        default)("#main .scroll-box-arrows .right").click(function() { (0, r.
            default)("#main .js-qv-mask").trigger("forward")
            })):
            ((0, r.
        default)("#main .js-qv-mask").removeClass("scroll"), (0, r.
        default)("#main .scroll-box-arrows").removeClass("scroll")), 1 == e) {
                var o = (0, r.
            default)(".quickview .js-qv-product-images li").length;
                if ("vertical" == style_scroll_quickview_attr) {
                    var a = (0, r.
                default)(".quickview .js-qv-mask").height();
                    1 != t && 0 != t || (size_item_quickview_attr = (0, r.
                default)(".quickview .js-qv-product-images li").height())
                } else {
                    var a = (0, r.
                default)(".quickview .js-qv-mask").width();
                    1 != t && 0 != t || (size_item_quickview_attr = (0, r.
                default)(".quickview .js-qv-product-images li").width())
                }
                size_item_quickview_attr * o - a >= size_item_quickview_attr ? ((0, r.
            default)(".quickview .js-qv-mask").addClass("scroll"), (0, r.
            default)(".quickview .js-arrows").addClass("scroll"), (0, r.
            default)(".quickview .js-arrows").show(), (0, r.
            default)(".quickview .js-qv-mask").unbind("backward"), (0, r.
            default)(".quickview .js-qv-mask").unbind("forward"), (0, r.
            default)(".quickview .js-qv-mask").scrollbox({
                    direction:
                    style_scroll_quickview_attr,
                    distance: size_item_quickview_attr,
                    autoPlay: !1,
                    step: 1
                }), (0, r.
            default)(".quickview .arrow-up").click(function() { (0, r.
                default)(".quickview .js-qv-mask").trigger("backward")
                }), (0, r.
            default)(".quickview .arrow-down").click(function() { (0, r.
                default)(".quickview .js-qv-mask").trigger("forward")
                })):
                ((0, r.
            default)(".quickview .js-qv-mask").removeClass("scroll"), (0, r.
            default)(".quickview .js-arrows").removeClass("scroll"), (0, r.
            default)(".quickview .js-arrows").hide())
            }
            var s = (0, r.
        default)(".js-product-images-modal .js-modal-product-images li").length;
            if ("vertical" == style_scroll_popup) {
                var l = (0, r.
            default)(".js-product-images-modal .js-modal-mask").height();
                1 == t && 0 != (0, r.
            default)(".js-product-images-modal .js-modal-product-images li").height() && (size_item_popup = (0, r.
            default)(".js-product-images-modal .js-modal-product-images li").height())
            } else {
                var l = (0, r.
            default)(".js-product-images-modal .js-modal-mask").width();
                1 == t && 0 != (0, r.
            default)(".js-product-images-modal .js-modal-product-images li").width() && (size_item_popup = (0, r.
            default)(".js-product-images-modal .js-modal-product-images li").width())
            }
            size_item_popup * s - l >= size_item_popup ? ((0, r.
        default)(".js-product-images-modal .js-modal-mask").addClass("scroll"), (0, r.
        default)(".js-modal-arrows").addClass("scroll"), (0, r.
        default)(".js-product-images-modal .js-modal-mask").unbind("backward"), (0, r.
        default)(".js-product-images-modal .js-modal-mask").unbind("forward"), (0, r.
        default)(".js-product-images-modal .js-modal-mask").scrollbox({
                direction:
                style_scroll_popup,
        ...
        default)(".arrow-up").click(function() { (0, r.
            default)(".js-product-images-modal .js-modal-mask").trigger("backward")
            }), (0, r.
        default)(".arrow-down").click(function() { (0, r.
            default)(".js-product-images-modal .js-modal-mask").trigger("forward")
            })):
            (0, r.
        default)(".js-modal-arrows").hide()
        }
        function n() { (0, r.
        default)(".js-file-input").on("change",
            function(t) {
                var e = void 0,
                n = void 0; (e = (0, r.
            default)(t.currentTarget)[0]) && (n = e.files[0]) && (0, r.
        ...
        default)("#quantity_wanted");
            ...
            function(t) {
                var e = (0, r.
            default)(".product-refresh");
                return (0, r.
            default)(t.currentTarget).trigger("touchspin.stopspin"),
                e.trigger("click", {
        ...
        function(i) {
            if (n(), t(), i && i.product_minimal_quantity) {
                var o = parseInt(i.product_minimal_quantity, 10); (0, r.
        ...
        default)(".js-product-images-modal").replaceWith(i.product_images_modal),
            ...
            (0, r.
        default)((0, r.
        default)(".tabs .nav-link.active").attr("href")).addClass("active").removeClass("fade")
        }),
        (0, r.
    default)(window).resize(function() {
            if ("vertical" == style_scroll_quickview_attr) var t = (0, r.
        default)(".quickview .js-qv-product-images li").height();
            else var t = (0, r.
        default)(".quickview .js-qv-product-images li").width();
            t > 0 ? e(!0, !0) : e(!0, !1)
...
default.responsive || {},
    u.
default.responsive.current_width = window.innerWidth,
    u.
default.responsive.min_width = 768,
    u.
...
default)(window).on("resize",
    ...
    default.responsive.min_width,
        ...
        i = t >= e && n < e || t < e && n >= e;
        u.
    default.responsive.current_width = n,
        u.
    default.responsive.mobile = u.
    default.responsive.current_width < u.
    default.responsive.min_width,
        ...
        t.fn.TouchSpin = function(e) {
            ...
            return this.each(function() {
                ...
                function d(e) {
                    ...
                    r.hasClass("input-group-btn") ? (n = '<button class="' + T.buttondown_class + ' bootstrap-touchspin-down" type="button">' + T.buttondown_txt + "</button>", r.append(n)) : (n = '<span class="input-group-btn"><button class="' + T.buttondown_class + ' bootstrap-touchspin-down" type="button">' + T.buttondown_txt + "</button></span>", t(n).insertBefore(j)),
                    o.hasClass("input-group-btn") ? (i = '<button class="' + T.buttonup_class + ' bootstrap-touchspin-up" type="button">' + T.buttonup_txt + "</button>", o.prepend(i)) : (i = '<span class="input-group-btn"><button class="' + T.buttonup_class + ' bootstrap-touchspin-up" type="button">' + T.buttonup_txt + "</button></span>", t(i).insertAfter(j)),
                    t(a).insertBefore(j),
                    t(s).insertAfter(j),
                    A = e
                }
                function p() {
                    ...
                    A = t(e).insertBefore(j),
                    t(".bootstrap-touchspin-prefix", A).after(j),
                    j.hasClass("input-sm") ? A.addClass("input-group-sm") : j.hasClass("input-lg") && A.addClass("input-group-lg")
                }
                function h() {
                    I = {
                ...
                function g() {
                    ...
                    I.down.on("mousedown.touchspin",
                    function(t) {
                        I.down.off("touchstart.touchspin"),
                        j.is(":disabled") || (x(), S(), t.preventDefault(), t.stopPropagation())
                    }),
                    I.down.on("touchstart.touchspin",
                    function(t) {
                    ...
                    function(t) {
                        ...
                        j.is(":disabled") || (w(), E(), t.preventDefault(), t.stopPropagation())
                    }),
                    ...
                    I.up.on("mouseout touchleave touchend touchcancel",
                    function(t) {
                        V && (t.stopPropagation(), C())
                    }),
                    I.down.on("mouseout touchleave touchend touchcancel",
                    function(t) {
                        V && (t.stopPropagation(), C())
                    }),
                    I.down.on("mousemove touchmove",
                    function(t) {
                        V && (t.stopPropagation(), t.preventDefault())
                    }),
                    I.up.on("mousemove touchmove",
                    function(t) {
                        V && (t.stopPropagation(), t.preventDefault())
                    }),
                    t(document).on(n(["mouseup", "touchend", "touchcancel"], i).join(" "),
                    function(t) {
                        V && (t.preventDefault(), C())
                    }),
                    t(document).on(n(["mousemove", "touchmove", "scroll", "scrollstart"], i).join(" "),
                    function(t) {
                        V && (t.preventDefault(), C())
                    }),
                ...
                function b() {
                    var t, e, n;
                    if ("" === (t = j.val())) return void("" !== T.replacementval && (j.val(T.replacementval), j.trigger("change")));
                    T.decimals > 0 && "." === t || (e = parseFloat(t), isNaN(e) && (e = "" !== T.replacementval ? T.replacementval: 0), n = e, e.toString() !== t && (n = e), e < T.min && (n = T.min), e > T.max && (n = T.max), n = y(n), Number(t).toString() !== n.toString() && (j.val(n), j.trigger("change")))
                }
                function _() {
                    if (T.booster) {
                ...
                function w() {
                    ...
                    e = _();
                    O += e,
                    O > T.max && (O = T.max, j.trigger("touchspin.on.max"), C()),
                    I.input.val(Number(O).toFixed(T.decimals)),
                    t !== O && j.trigger("change")
                }
                function x() {
                    b(),
                    O = parseFloat(I.input.val()),
                    ...
                    e = _();
                    O -= e,
                    O < T.min && (O = T.min, j.trigger("touchspin.on.min"), C()),
                ...
                var T, A, I, O, k, D, N, P, j = t(this),
                L = j.data(),
                B = 0,
                V = !1; !
                function() {
                    j.data("alreadyinitialized") || (j.data("alreadyinitialized", !0), i += 1, j.data("spinnerid", i), j.is("input") && (l(), a(), b(), f(), h(), m(), g(), v(), I.input.css("display", "block")))
                } ()
            })
        }
    } (jQuery)
...
function(t, e, n) {
    ...
    function() {
        ...
        function(t) {
            ...
            t(document).on(c.CLICK_DATA_API, u.DATA_TOGGLE_CARROT,
            function(e) {
                e.preventDefault();
                var n = e.target;
            ...
            g = function() {
                ...
                l.prototype.to = function(e) {
                    ...
                    if (! (e > this._items.length - 1 || e < 0)) {
                        if (this._isSliding) return void t(this._element).one(p.SLID,
                        function() {
                            return n.to(e)
                        });
                ...
                l.prototype._slide = function(e, n) {
                    ...
                    if (!this._triggerSlideEvent(a, l).isDefaultPrevented() && r && a) {
                        ...
                        o.supportsTransitionEnd() && t(this._element).hasClass(h.SLIDE) ? (t(a).addClass(e), o.reflow(a), t(r).addClass(l), t(a).addClass(l), t(r).one(o.TRANSITION_END,
                        function() {
        ...
        function(t) {
            ...
            t(document).on(f.CLICK_DATA_API, h.DATA_TOGGLE,
            function(e) {
                e.preventDefault();
        ...
        function(t) {
            ...
            h = function() {
                ...
                l.prototype.show = function(e) {
                    ...
                    this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), t(document.body).addClass(d.OPEN), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(f.CLICK_DISMISS, p.DATA_DISMISS, t.proxy(this.hide, this)), t(this._dialog).on(f.MOUSEDOWN_DISMISS,
                    function() {
                        t(n._element).one(f.MOUSEUP_DISMISS,
                        function(e) {
                ...
                l.prototype._enforceFocus = function() {
                    var e = this;
                    t(document).off(f.FOCUSIN).on(f.FOCUSIN,
                    function(n) {
                ...
                l.prototype._setEscapeEvent = function() {
                    var e = this;
                    this._isShown && this._config.keyboard ? t(this._element).on(f.KEYDOWN_DISMISS,
                    function(t) {
                        27 === t.which && e.hide()
                ...
                l.prototype._showBackdrop = function(e) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        ...
                        if (this._backdrop = document.createElement("div"), this._backdrop.className = d.BACKDROP, i && t(this._backdrop).addClass(i), t(this._backdrop).appendTo(document.body), t(this._element).on(f.CLICK_DISMISS,
                        function(t) {
            ...
            t(document).on(f.CLICK_DATA_API, p.DATA_TOGGLE,
            function(e) {
                var n = this,
                i = void 0,
                ...
                var l = t(i).one(f.SHOW,
                function(e) {
                    e.isDefaultPrevented() || l.one(f.HIDDEN,
                    function() {
        ...
        function(t) {
            ...
            t(document).on(l.CLICK_DATA_API, c.DATA_TOGGLE,
            function(e) {
                e.preventDefault(),
        ...
        return function t(e, n, r) {
            ...
            6 : [function(t, e, n) {
                ...
                e.exports = function(t) {
                    ...
                    e.children.push(n);
                    t.flexStyle.mainLines = i(t.lines,
                    function(t, e) {
                        return Math.max(t, e.main)
                    },
                    0),
                    t.flexStyle.crossLines = i(t.lines,
                    function(t, e) {
                        return t + e.cross
                    },
                    0),
            ...
            10 : [function(t, e, n) {
                e.exports = function(t) {
                    for (var e, n = 0,
                    i = -1; e = t.children[++i];)"auto" === e.flexStyle.mainBefore && ++n,
            ...
            15 : [function(t, e, n) {
                ...
                function o(t, e) {
                    for (var n; n = s.exec(e);) {
                        t[n[1].toLowerCase().replace(/-[a-z]/g,
                        function(t) {
...
function(t, e, n) {
    ...
    function(t, e, n) {
        ...
        function g(t, e, n) {
            n.forEach(function(n) { - 1 === e.indexOf(n) && p(t, n) && f(t, n)
            }),
            ...
            },
            {
                ...
                value: function() {
                    ...
                    if (this.enabled) {
                        ...
                        d = _(d, h),
                        p = _(p, m);
                        for (var g = c.left + p.left - d.left,
                        v = c.top + p.top - d.top,
                        ...
                        function() {
                            ...
                            n = t.cache("target-offsetparent-bounds",
                            function() {
                                return s(e)
                            }),
        ...
        E.modules.push({
            position: function(t) {
                ...
                D(function() { ! 1 !== e.options.addTargetClasses && g(e.target, m, h),
                    g(e.element, m, h)
                }),
                {
                    top: n,
        ...
        E.modules.push({
            position: function(t) {
                ...
                D(function() { ! 1 !== e.options.addTargetClasses && g(e.target, p, d),
                    g(e.element, p, d)
                }),
                !0
            }
