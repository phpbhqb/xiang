...
$ecms_config['esafe']['ecookiernd']='metAmhdmtEW5CGMwqQZiYyXWEB03JTuIDJo1';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='yulav';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='wtnho';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='QQiWgWYfR6so97RzEXGUQOY80uPP5MhCVtk';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='aw1NQCLyQHz5mqDEq71Aevpmv6NiOXn968';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='4qj7sFPGPHULakBJc8Ycd4IoKNfj4pdQM';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='uDD5F2XWmyIctsj2eNF6GAk36lWTIggI';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='UQDWSbgvxFTEOjlSHEC3FUOz9uNB1iN';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'smalltextlen'=>160,
'defaultgroupid'=>1,
'fileurl'=>'http://test.com/xiang/d/file/',
'install'=>0,
'phpmode'=>0,
'dorepnum'=>300,
'loadtempnum'=>50,
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'wa5dPTq3KjOKbTgvm6cRWclmp0T6g0iC',
...
'fbkey_ok'=>1,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"http://test.com/xiang/shop/\">shop</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'openfileserver'=>0,
'fs_purl'=>'',
'closemods'=>',down,movie,pay,rss,search,sch,error,member,pl,print,mconnect,fieldand,gb,mlist,',
'fieldandtop'=>0,
'fieldandclosetb'=>'',
'filedatatbs'=>',1,',
'filedeftb'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'p64X3AWhrcU66y3OWGFQa9JJzMSjMcGLWuqG',
'mhavedatedo'=>0,
'reportkey'=>1,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'JaFphs1iQc01gUQWKD0oCbcBBUaYAhGIp4BqJsISlt',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
'ctimeaddre'=>0,
'ctimeqaddre'=>0,
'deftempid'=>0,'add_company_email'=>'info@aquamilano.it');
//------------e_public
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,newstime,intro,titlepic,productpic,newstext,',
'qenter'=>',',
'listtempf'=>',title,newstime,intro,titlepic,productpic,newstext,',
'tempf'=>',title,newstime,intro,titlepic,productpic,newstext,',
'mustqenterf'=>',title,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,intro,newstext,',
'cj'=>',title,newstime,intro,titlepic,productpic,newstext,',
'canaddf'=>',title,newstime,intro,titlepic,productpic,newstext,',
'caneditf'=>',title,newstime,intro,titlepic,productpic,newstext,',
'tbmainf'=>',title,titlepic,newstime,intro,productpic,newstext,',
'tbdataf'=>',',
'tobrf'=>',intro,newstext,',
'dohtmlf'=>',intro,productpic,newstext,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
