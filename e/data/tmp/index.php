...
<main id="page" style="padding-top: 215px;">
<header id="header">
...
<section id="wrapper">
  ...
  <div class="container">
    <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
      ...
      <a itemprop="item" href="https://www.aquamilano.it/it/">
...
<div class="row">
  <div id="content-wrapper" class="col-lg-12 col-xs-12">
    ...
    <section id="content" class="page-home">
      ...
      <!--huan deng pian -->
      <!-- @file modulesappagebuilderviewstemplateshookApRow -->
      <div class="wrapper">
        <div class="fullwidth">
          <div class="row box-start box-slideshow ApRow has-bg bg-boxed" data-bg=" no-repeat" style="background: no-repeat;">
            <!-- @file modulesappagebuilderviewstemplateshookApColumn -->
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12 ApColumn ">
              <!-- @file modulesappagebuilderviewstemplateshookApSlideShow -->
              <div id="slideshow-form_5458796618948806" class="ApSlideShow">
				<div class="bannercontainer banner-fullwidth" style="padding: 0px;margin: 0px;"> 
				  <div class="iview iview-group-5b1a4d84477b6-10"> 
				  
					<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select fname,picurl,comment from {$dbtbpre}enewsfocus where classid=1 order by fsort",0,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
					<!-- SLIDE IMAGE BEGIN --> 
						<div class="slide_config " data-leo_image="<?=$bqr['picurl']?>" data-leo_pausetime="5000" data-leo_thumbnail="<?=$bqr['picurl']?>" data-leo_background="image"> 
						<div class="tp-caption  font-extra-light" data-x="1436" data-y="259" data-transition="fade" style="font-size:44px;color:#ffffff;"> 
						 <!-- LAYER TEXT BEGIN --> 
						 <?=$bqr['fname']?>
						 <!-- LAYER TEXT END --> 
						 <!-- LAYER IMAGE END --> 
						...
						<div class="tp-caption  font-light" data-x="1438" data-y="394" data-transition="fade" style="font-size:17px;color:#ffffff;"> 
						 <!-- LAYER TEXT BEGIN --> 
						 <?=$bqr['comment']?>
						 <!-- LAYER TEXT END --> 
						 <!-- LAYER IMAGE END --> 
						...
						<div class="tp-caption " data-x="1516" data-y="34" data-transition="fade"> 
						 <!-- LAYER TEXT END --> 
						 <!-- LAYER IMAGE BEGIN --> 
						 <img src="http://test.com/xiang/skin/xiang/images/Logo.png" alt="" class="img_disable_drag" /> 
						 <!-- LAYER IMAGE END --> 
						 <!-- LAYER VIDEO END --> 
						</div> 
					   </div>
...
?>
                ...
                <script type="text/javascript">
                  ...
                  jQuery(".iview-group-5b1a4d84477b6-10").iView({
                    // COMMON
                ...
                // Fix : Slide link, image cant swipe
                  ...
                  // step 3
                  $(".iview-group-5b1a4d84477b6-10 .slide_config").on("click",function(){
                    if(link_event !== 'click'){
                      link_event = 'click';
                      return;
                    }
                  ...
                  // step 2
                  $(".iview-group-5b1a4d84477b6-10 .slide_config").on('swipe',function(){
	  ...
	  <!-- @file modulesappagebuilderviewstemplateshookApRow --> 
        <div class="wrapper"> 
         <div class="container"> 
          <div class="row box-banner-sale ApRow  has-bg bg-boxed" data-bg=" no-repeat" style="background: no-repeat;"> 
		  
			<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select classid,classname,classimg from {$dbtbpre}enewsclass where bclassid!=0 and showclass=0 order by myorder,classid",0,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
				...
				<!-- @file modulesappagebuilderviewstemplateshookApImage --> 
				<div id="image-form_<?=$bqr['classid']?>" class="block banner-sale special zoom-effect ApImage"> 
				 <a href="<?=sys_ReturnBqClassname($bqr,9)?>"> <img src="<?=$bqr['classimg']?>" class="img-fluid " title="" alt="" style=" width:100%; 
				height:100%" /> </a> 
				</div> 
			   </div>
			<?php
...
?>
		...
		<section class="featured-products clearfix block"> 
         <h1 class="products-section-title title_block"> Popular Products </h1> 
         <div class="block_content"> 
          <div class="products"> 
           <div class="owl-row"> 
			...
			<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select id,title,titleurl,titlepic,productpic from {$dbtbpre}ecms_shop order by isgood desc,newstime desc limit 8",0,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
          ...
          <a class="float-xs-right btn btn-outline btn-view-all" href="http://test.com/xiang/shop/"> All products </a> 
         </div> 
        </section> 
