...
<script type="text/javascript">
  ...
  <body id="category" class="lang-it country-it currency-eur layout-left-column page-category tax-display-enabled category-id-2 category-home category-id-parent-1 category-depth-level-1 fullwidth keep-header">
...
<aside id="notifications">
  ...
  <div class="container">
      ...
      <img src="[!--news.url--]skin/xiang/images/bg-breadcrumb.jpg" class="img-fluid" alt="Breadcrumb image">
    </div>
  </nav>
  ...
  <div id="search_filter_controls" class="hidden-md-up">
    ...
    <div id="search_filters" class="block">
      ...
      <h4 class="title_block h6 hidden-sm-down">select</h4>
    
    <div class="block_content">
      
        <!--<div id="_desktop_search_filters_clear_all" class="hidden-sm-down clear-all-wrapper">
          <button data-search-url="[!--news.url--]" class="btn btn-tertiary js-search-filters-clear-all">
            ...
            <h1 class="h6 facet-title hidden-sm-down">Category</h1>
                                                                                                                                                                                                            <div class="title hidden-md-up" data-target="#facet_86909" data-toggle="collapse">
              <h1 class="h6 facet-title">Category</h1>
	...
	?>
                ...
                <ul id="facet_86909" class="collapse">
				<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select classid,classname from {$dbtbpre}enewsclass where bclassid={$bclassid} and showclass=0",0,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
				<li>
                        <label class="facet-label" for="facet_input_<?=$bqr['classid']?>">
                                                     <!-- <span class="custom-checkbox">
                              <input
				id="facet_input_<?=$bqr['classid']?>"
                                data-search-url="<?=sys_ReturnBqClassname($bqr,9)?>"
                                type="checkbox" <?php if($bqr['classid']==$classid):?>checked <?php endif;?>
                                                              >
                                                              <span  class="ps-shown-by-js" ><i class="material-icons checkbox-checked">&#xE5CA;</i></span>
                                                          </span>-->
                          
                          <a
                            href="<?=sys_ReturnBqClassname($bqr,9)?>"
...
?>
  ...
  <div class="row">
    <div class="col-lg-6 col-md-3 hidden-sm-down total-products">     
        ...
        <div class="display">
          <div id="grid" class="selected leo_grid selected"><a rel="nofollow" href="#" title="Grid"><i class="icon-grid fa fa-th"></i></a></div>
